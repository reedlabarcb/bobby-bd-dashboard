...
export function ContactsTable({
  ...
  function LeaseExpiryCell({
    ...
    let badge = "bg-zinc-500/15 text-slate-700 border-zinc-500/30";
    if (monthsRemaining !== null) {
      if (monthsRemaining < 0) badge = "bg-zinc-500/10 text-slate-600 border-zinc-500/20";
      ...
      else if (monthsRemaining <= 24) badge = "bg-blue-500/15 text-blue-500 border-blue-500/30";
    }
    const monthLabel =
